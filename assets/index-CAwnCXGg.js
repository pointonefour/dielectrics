...
`,t),null}let Pt=W.getAttribute(`version`);console.debug(`THREE.ColladaLoader: File version`,Pt);let Ft=d(n(W,`asset`)[0]),It=new co(this.manager);It.setPath(this.resourcePath||t).setCrossOrigin(this.crossOrigin);let Lt;fp&&(Lt=new fp(this.manager),Lt.setPath(this.resourcePath||t));let Rt=new J,zt=[],Bt={},Vt=0,K={animations:{},clips:{},controllers:{},images:{},effects:{},materials:{},cameras:{},lights:{},geometries:{},nodes:{},visualScenes:{},kinematicsModels:{},physicsModels:{},kinematicsScenes:{}};m(W,`library_animations`,`animation`,_),m(W,`library_animation_clips`,`animation_clip`,j),m(W,`library_controllers`,`controller`,re),m(W,`library_images`,`image`,le),m(W,`library_effects`,`effect`,fe),m(W,`library_materials`,`material`,Oe),m(W,`library_cameras`,`camera`,je),m(W,`library_lights`,`light`,Pe),m(W,`library_geometries`,`geometry`,ze),m(W,`library_nodes`,`node`,mt),m(W,`library_visual_scenes`,`visual_scene`,wt),m(W,`library_kinematics_models`,`kinematics_model`,Xe),m(W,`library_physics_models`,`physics_model`,rt),m(W,`scene`,`instance_kinematics_scene`,ot),h(K.animations,b),h(K.clips,ne),h(K.controllers,oe),h(K.images,ue),h(K.effects,Ee),h(K.materials,P),h(K.cameras,I),h(K.lights,Le),h(K.geometries,Ke),h(K.visualScenes,Tt),V(),B();let Ht=Ot(n(W,`scene`)[0]);return Ht.animations=zt,Ft.upAxis===`Z_UP`&&(console.warn(`THREE.ColladaLoader: You are loading an asset with a Z-UP coordinate system. The loader just rotates the asset to transform it into Y-UP. The vertex data are not converted, see #24289.`),Ht.rotation.set(-Math.PI/2,0,0)),Ht.scale.multiplyScalar(Ft.unit),{get animations(){return console.warn(`THREE.ColladaLoader: Please access animations over scene.animations now.`),zt},kinematics:Bt,library:K,scene:Ht}}},mp=new Xd,hp=new sp,gp=new cp,_p=new up,vp=new pp;function yp(e,t,n){let r=URL.createObjectURL(e),i=e.name.split(`.`).pop().toLowerCase(),a=new Oa({color:8947848});switch(i){case`glb`:case`gltf`:mp.load(r,e=>bp(e.scene,r,n));break;case`obj`:hp.load(r,e=>bp(e,r,n));break;case`stl`:gp.load(r,e=>bp(new X(e,a),r,n));break;case`ply`:_p.load(r,e=>{e.computeVertexNormals(),bp(new X(e,a),r,n)});break;case`dae`:vp.load(r,e=>bp(e.scene,r,n));break;default:console.error(`Format not supported`),URL.revokeObjectURL(r)}}function bp(e,t,n){Pd.add(e),URL.revokeObjectURL(t),n&&n(e)}function xp(e,t,n){let r=new Zt().setFromObject(e),i=r.getCenter(new U),a=r.getSize(new U),o=Math.max(a.x,a.y,a.z)*2;t.position.set(i.x+o,i.y+o,i.z+o),n.target.copy(i),t.lookAt(i),n.update()}function Sp(e){let t=document.getElementById(`contextMenu`),n=document.getElementById(`dropOverlay`),r=document.getElementById(`meshUpload`),i=document.getElementById(`dropZone`);window.addEventListener(`dragover`,e=>{e.preventDefault(),n.classList.add(`active`)}),window.addEventListener(`dragleave`,e=>{e.relatedTarget===null&&n.classList.remove(`active`)}),window.addEventListener(`drop`,t=>{t.preventDefault(),n.classList.remove(`active`),t.dataTransfer.files.length>0&&Cp(t.dataTransfer.files[0],e)}),i&&i.addEventListener(`click`,()=>r.click()),r.addEventListener(`change`,t=>{t.target.files.length>0&&Cp(t.target.files[0],e)});let a=document.getElementById(`gridToggleBtn`);a&&(a.classList.add(`active`),a.addEventListener(`click`,t=>{let n=e.onToggleGrid();a.classList.toggle(`active`,n)}));let o=document.getElementById(`snapToggleBtn`),s=!1;o&&o.addEventListener(`click`,()=>{s=!s,e.onToggleSnap(s),o.classList.toggle(`active`,s)}),wp(e,t)}function Cp(e,t){let n=e.name.split(`.`).pop().toLowerCase();[`glb`,`gltf`,`obj`,`stl`,`ply`,`dae`].includes(n)?yp(e,Ed,e=>{xp(e,Od,Ad),t.onLoad(e)}):[`hdr`,`exr`].includes(n)?console.log(`HDR system coming soon...`):alert(`Unsupported format: .`+n)}function wp(e,t){document.getElementById(`undoBtn`)?.addEventListener(`click`,t=>{t.preventDefault(),e.onUndo()}),document.getElementById(`redoBtn`)?.addEventListener(`click`,t=>{t.preventDefault(),e.onRedo()});let n=(n,r)=>{document.getElementById(n)?.addEventListener(`mousedown`,n=>{n.stopPropagation(),n.preventDefault(),e.onSetMode(r),t.style.display=`none`})};n(`menuTranslate`,`translate`),n(`menuRotate`,`rotate`),n(`menuScale`,`scale`),document.getElementById(`menuDelete`)?.addEventListener(`mousedown`,n=>{n.stopPropagation(),e.onDelete(),t.style.display=`none`})}var Tp,Ep=null,Dp=null;function Op(){jd.selectedObjects=Ep?[Ep]:[]}function kp(){Ld(),Tp=new bu(Od,kd.domElement);let e=Tp.getHelper?Tp.getHelper():Tp;Dd.add(e),Tp.addEventListener(`dragging-changed`,e=>{Ad.enabled=!e.value}),Tp.addEventListener(`mouseDown`,()=>{Ep&&(Dp=Ud(Ep))}),Tp.addEventListener(`mouseUp`,()=>{Ep&&Dp&&Gd(Ep,Dp,Ud(Ep))}),window.addEventListener(`mousedown`,Ap),window.addEventListener(`contextmenu`,jp),Jd(Tp,()=>Ep,Mp),Sp({onLoad:e=>{Ep=e,Tp.detach(),Op()},onSetMode:e=>{Ep&&(Tp.attach(Ep),Tp.setMode(e))},onDelete:Mp,onUndo:()=>Kd(Tp),onRedo:()=>qd(Tp),onToggleGrid:()=>Nd?(Nd.visible=!Nd.visible,Nd.visible):!1,onToggleSnap:e=>{e?(Tp.setTranslationSnap(1),Tp.setRotationSnap(kt.degToRad(15))):(Tp.setTranslationSnap(null),Tp.setRotationSnap(null))}}),Rd()}function Ap(e){if(e.target.closest(`#contextMenu`)||e.target.closest(`#dropZone`)||e.target.closest(`.ui-button`)||(document.getElementById(`contextMenu`).style.display=`none`,Tp.axis!==null)||e.button!==0)return;let t=zd(e);t?(Ep=t,Tp.attach(Ep)):Tp.dragging||(Ep=null,Tp.detach()),Op()}function jp(e){e.preventDefault();let t=zd(e);if(t){Ep=t,Tp.attach(Ep),Op();let n=document.getElementById(`contextMenu`);n.style.display=`block`,n.style.left=`${e.clientX}px`,n.style.top=`${e.clientY}px`}else document.getElementById(`contextMenu`).style.display=`none`}function Mp(){Ep&&(Tp.detach(),Ep.traverse(e=>{e.isMesh&&(e.geometry.dispose(),Array.isArray(e.material)?e.material.forEach(e=>e.dispose()):e.material.dispose())}),Pd.remove(Ep),Ep=null,Op())}kp();